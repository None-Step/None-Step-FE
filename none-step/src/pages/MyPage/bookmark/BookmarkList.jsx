...
export const BookmarkPlace = ({color, placeName, placeAddress}) => {
  return (
    <ListContainer>
      <ListItem>
        <Star color={color} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        13.4142L7.04999 18.3642L5.63599 16.9502L10.586 12.0002L5.63599 7.05023L7.04999 5.63623L12 10.5862Z" fill="#666666"/>
      </svg>
  </ListContainer>
  )
}

export const BookmarkPath = ({color, placeName, placeAddress}) => {
  return (
    <ListContainer>
      <ListItem>
        <Star color={color} fill="none" xmlns="http://www.w3.org/2000/svg">
