      ...
      <MainWrapper>
        ...
        <MainSection>
          <div
            ...
            style={{ transform: `translateX(-${currentBanner * 25}%)` }}
          >
        ...
        <CategoryWrapper>
          ...
          >
            <li className="congestion">
              <CategoryBtn onClick={() => handleClickMap('congestion')}>
                <img src={congestionIcon} alt="congestion-icon" />
                <span>지하철혼잡도</span>
              </CategoryBtn>
            </li>
            <li className="elevator">
              <CategoryBtn onClick={() => handleClickMap('elevator')}>
                <img src={elevatorIcon} alt="elevator-icon" />
                <span>엘리베이터</span>
              </CategoryBtn>
            </li>
            <li className="escalator">
              <CategoryBtn onClick={() => handleClickMap('escal')}>
            ...
            <li className="wheelchair_lift">
              <CategoryBtn onClick={() => handleClickMap('lift')}>
                <img src={wheelchairLiftIcon} alt="wheelchair-lift-icon" />
                <span>휠체어리프트</span>
              </CategoryBtn>
            </li>
            <li className="toilet">
              <CategoryBtn onClick={() => handleClickMap('toilet')}>
                <img src={toiletIcon} alt="toilet-icon" />
                <span>화장실</span>
              </CategoryBtn>
            </li>
            <li className="dif_toilet">
              <CategoryBtn onClick={() => handleClickMap('dif-toilet')}>
                <img src={difToiletIcon} alt="dif-toilet-icon" />
                <span>장애인 화장실</span>
              </CategoryBtn>
            </li>
            <li className="nursing_room">
              <CategoryBtn onClick={() => handleClickMap('nursing-room')}>
                <img src={nursingRoomIcon} alt="nursing-room-icon" />
                <span>수유실</span>
              </CategoryBtn>
            </li>
            <li className="atm">
            ...
            <li className="wheelchair_charger">
              <CategoryBtn onClick={() => handleClickMap('charger')}>
                <img
            ...
            <li className="customer_service">
              <CategoryBtn onClick={() => handleClickMap('center')}>
        ...
        <WeatherWrapper>
          ...
          <WeatherContainer>
            ...
            {isLocation == null && isWeather == null && (
              <div className="no_weather">
                <SpinnerBlue src={spinnerBlueIcon} alt="loading_icon" />
              </div>
            )}
          </WeatherContainer>
        </WeatherWrapper>
        ...
        <FooterWrapper>
          <FooterContainer>
            <p className="qna">
              <span>문의하기</span>
              <span onClick={kakaoChatting}>카카오톡 1:1 채팅</span>
            </p>
            <p className="license">
              <span>라이선스</span>
              <span onClick={handleClickLicense}>오픈소스 라이선스</span>
            </p>
